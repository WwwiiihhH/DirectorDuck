...
import com.example.directorduck_v10.fragments.practice.compare.CompareQuestion
...
class CompareSizeGameActivity : AppCompatActivity() {
    ...
    private fun finishGame() {
        ...
        if (wrongList.isEmpty()) {
            ...
            rvWrong.adapter = com.example.directorduck_v10.fragments.practice.compare.adapters.CompareWrongAdapter(wrongList)
        }
